...
<!-- jQuery Knob Chart -->
<script src="{{ asset('public/admin-assets/plugins/knob/jquery.knob.js') }}"></script>
<!-- daterangepicker -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.2/moment.min.js"></script>
<script src="{{ asset('public/admin-assets/plugins/daterangepicker/daterangepicker.js') }}"></script>
<!-- datepicker -->
<script src="{{ asset('public/admin-assets/plugins/datepicker/bootstrap-datepicker.js') }}"></script>
<!-- Bootstrap WYSIHTML5 -->
...
<script src="{{ asset('public/admin-assets/plugins/jQuery/jquery-2.2.3.min.js') }}"></script>
  <link rel="stylesheet" href="{{ asset('public/admin-assets/plugins/iCheck/flat/blue.css') }}">
